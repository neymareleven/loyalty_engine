...
def get_segments_ui_catalog():
    return {
        ...
        "list": {
            ...
            "contract": "len(items) <= limit; total = filtered count; SQL LIMIT/OFFSET after filters and sort",
            "queryParams": {
                ...
                "sort_by": "name | created_at | updated_at | last_computed_at | member_count | ...",
                "sort_order": "asc | desc",
            },
        },
        "unomi": {
...
def list_segments(
    ...
    sort_by: str | None = Query(
        None,
        description="Sort field on the full filtered catalog (default created_at).",
    ),
